...
/**
  * Cette class implemente le systÃ¨me d'identification numÃ©rique des drones franÃ§ais conformÃ©ment Ã 
...
public:
    ...
    /**
     * Setter pour les coordonnÃ©es GPS en entier en centidegrees
     * @param lat
     * @param lon
     */
    ...
    */
    /**
     * Setter pour les coordonnÃ©es GPS en double en centidegrees
    ...
    /**
     * Setter position avec les coordonnÃ©es GPS en double en centidegrees + altitude
     * Converti les valeurs en entiers.
     * @param lat
     * @param lon
     * @param alt
    ...
    /**
     * Setter position Home avec les coordonnÃ©es GPS en entiers en centidegrees + altitude
     * @param lat
     * @param lon
     * @param alt
     */
    ...
    /**
     * Setter position Home avec les coordonnÃ©es GPS en double en centidegrees + altitude
     * Converti les valeurs en entiers.
     * @param lat
     * @param lon
     * @param alt
    ...
    /**
     * Setter pour la hauteur au sol par rapport au point de dÃ©collage en m
     * @param height
     */
    ...
    /**
     * Setter pour les coordonnÃ©es GPS en entiers en centidegrees
     * @param lat
     * @param lon
     */
     ...
     * Utiliser cette fonction pour changer l'id par dÃ©fault
     * @param id_value
     */
    ...
    /**
     * GenÃ¨re la frame 802.11 beacon complÃ¨te
    ...
    /**
     * GenÃ¨re le contenu de l'identification drone
     * @param full_frame beacon frame buffer
     * @param start_from starting offset on the buffer
     * @return buffer space used
     */
    ...
    /**
     * Sauvegarde la derniÃ¨re fois qu'une trame a Ã©tÃ© envoyÃ© pour respecter le timing d'une trame toutes les 3s
     */
    void set_last_send() {
		// Temps
	...
	/**
     * Notifie si la position Home est dÃ©finie
    ...
    /**
     * Notifie quand 3s sont passÃ©s pour envoyer une nouvelle trame.
    ...
    /**
     * Notifie quand le drone a bougÃ© de plus de 30m en moins de 3s.
    ...
    /**
     * Notifie si la condition de distance ou de temps est passÃ© pour envoyer une nouvelle trame.
     * @return
     */
    bool time_to_send() {
...
private:
    ...
    /**
     * Enumeration des types de donnÃ©es Ã  envoyer
     */
    ...
    /**
     * Tableau TLV (TYPE, LENGTH, VALUE) avec les tailles attendu des diffÃ©rents type donnÃ©es.
     */
    ...
    // Taken from TinyGPS++
    /**
     * Calcule une approximation de la distance entre deux coordonnÃ©es WS84 (GPS)
     * @param lat1
     * @param long1
     * @param lat2
     * @param long2
